...
import team.jfshop.jinfengshopserver.dao.ProductImgMapper;
import team.jfshop.jinfengshopserver.dao.ProductMapper;
import team.jfshop.jinfengshopserver.dao.ProductParamsMapper;
import team.jfshop.jinfengshopserver.dao.ProductSkuMapper;
import team.jfshop.jinfengshopserver.bean.*;
import team.jfshop.jinfengshopserver.service.ProductService;
import team.jfshop.jinfengshopserver.util.PageHelper;
...
public class ProductServiceImpl implements ProductService {
    ...
    public ResultVO listBrands(String keyword) {
        keyword = "%"+keyword+"%";
        List<String> brands = productMapper.selectBrandKeyword(keyword);
        return new ResultVO(ResStatus.OK,"SUCCESS",brands);
    }
}
